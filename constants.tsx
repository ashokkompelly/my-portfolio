...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'A custom mobile application for Quick Commerce, designed to enhance user engagement and streamline the shopping experience.',
    tags: ['React Native', 'Node.js', 'Azure Cosmos DB', 'Mobile App', 'Android', 'iOS'],
    imageUrl: 'https://media.istockphoto.com/id/1300476661/photo/high-angle-view-asian-chinese-womans-hand-on-mobile-app-for-online-food-delivery-with-laptop.jpg?s=1024x1024&w=is&k=20&c=59FWoXiiiJ-Op_r40e79f38MYp27YvTwXUOunhsvHRM=',
