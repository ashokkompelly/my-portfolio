...
const Projects: React.FC = () => {
  return (
    <section
      id="projects"
      className="relative py-20 md:py-32 px-6 scroll-mt-24"
    >
        ...
        <div className="mb-12 md:mb-20">
          ...
          >
            ...
            <p className="text-slate-500 max-w-2xl text-base md:text-lg leading-relaxed">
              A detailed look at the digital solutions I've architected and
              implemented.
            </p>
          </motion.div>
        </div>
            ...
            >
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute bottom-4 md:bottom-6 left-4 md:left-6 flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 md:px-4 py-1 md:py-1.5 bg-blue-950/80 backdrop-blur-xl rounded-full text-[8px] md:text-[9px] text-blue-400 font-extrabold uppercase tracking-widest border border-blue-500/30"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="p-6 md:p-10">
                ...
                <div className="flex items-center justify-between border-t border-blue-500/10 pt-6 md:pt-8">
                  <a
                    href={project.link}
                    className="text-white text-[10px] md:text-sm font-extrabold flex items-center gap-2 md:gap-3 group/link uppercase tracking-widest"
                  >
                    View Project
                    <ArrowRight
                      size={16}
                      className="text-blue-500 group-hover/link:translate-x-2 transition-transform"
                    />
                  </a>
