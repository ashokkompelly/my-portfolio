...
import { Terminal, Link2, Github, Linkedin, Twitter, Zap, Smartphone, Headset } from 'lucide-react';
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-start gap-6 md:gap-8 mb-12 md:mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-4 md:mb-6">About Me</h2>
          ...
          <p className="text-slate-500 max-w-md text-base md:text-lg font-medium leading-relaxed">
            Passionate about coding, problem-solving, and building the future of the web.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            <div>
              ...
              <p className="text-xl md:text-2xl text-slate-200 leading-relaxed font-semibold mb-6 md:mb-8">
                I specialize in crafting high-end, scalable web solutions that drive growth and engagement.
              </p>
          ...
          <div className="md:col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div>
                <p className="text-white font-bold text-sm md:text-base">Fast Performance</p>
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider mt-1">Optimization Expert</p>
              </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <div>
                <p className="text-white font-bold text-sm md:text-base">Responsive Design</p>
                <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider mt-1">Mobile First Approach</p>
              </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              ...
              <div>
                <p className="text-white font-bold text-sm md:text-base">Client Support</p>
                <p className="text-[10px] text-blue-400 font-bold uppercase tracking-wider mt-1">Always Available</p>
              </div>
            </motion.div>
          </div>
        </div>
